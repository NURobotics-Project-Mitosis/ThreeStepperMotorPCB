...
class StepperMotor 
{
  ...
  public: 
    ...
    StepperMotor(int stepsPerRevolution, int step, int dir) : 
  ...
  private:
    ...
    */
    void updateShiftRegister(byte motors)
    {
...
StepperMotor motorX(200, 10, 9);  // Motor X
